...
const MenuBar_ClickableMenu_Wrapper = document.querySelector(".MenuBar_ClickableMenu_Wrapper");
            ...
            function MenuToggle() {
                ...
                setTimeout(() => {
                    MenuBar_ClickableMenu_Wrapper.classList.add("display_none");
    ...
    MenuBar_OverflowMenuIcon.addEventListener("click", () => {
        if (MenuBar_ClickableMenu_Wrapper.classList.contains("display_none")) {
            MenuBar_ClickableMenu_Wrapper.classList.toggle("display_none");
  ...
  return new Promise ((resolve, reject) => {
    ...
    image.onerror = () => reject();
                ...
                document.addEventListener("mouseup", e => {
                    ...
                    if (diffX > 20) {            // How many pixel dragged to activate this function
                        ToPreviousImage();
                    }
